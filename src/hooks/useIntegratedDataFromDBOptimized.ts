...
import type { IntegratedRecord, IntegratedDataResult } from '../components/lookups/types';

// API base URL - use environment variable or fallback to default
const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://kerry-fleet-saas.onrender.com';
